...
function NameStep({ defaultName = '', onComplete }) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#1B1B1D] text-white flex items-center justify-center p-6 font-sans select-none">
...
function OnboardingFlow({ pendingUser, onComplete }) {
  ...
  return (
    <div className="h-screen w-full bg-[#1B1B1D] text-white flex font-sans overflow-hidden">
      {/* Left */}
...
export default function AuthPage({ onAuthSuccess, onNavigateLegal }) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#1B1B1D] text-[#ececed] select-none flex items-center justify-between p-4 md:p-5 font-sans overflow-hidden">
      {/* Left auth form */}
