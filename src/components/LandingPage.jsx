...
export default function LandingPage({ onSignUp, onSignIn, onNavigatePricing, onNavigateLegal }) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#14120B] text-white font-sans selection:bg-white selection:text-black">
      ...
      <header className="sticky top-0 z-50 w-full bg-[#14120B] px-6 py-4 select-none">
      ...
      <section id="about-us" className="py-28 px-6 sm:px-12 max-w-7xl mx-auto border-t border-white/[0.08] bg-[#14120B] text-left">
        ...
        <div className="w-full rounded-3xl border border-white/10 bg-[#14120B] overflow-hidden p-3 sm:p-4 mb-20 shadow-2xl">
          <div className="relative w-full rounded-2xl overflow-hidden bg-[#17150f] border border-white/5 aspect-[16/8] flex items-center justify-center group cursor-pointer">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#14120B] via-transparent to-transparent pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          <div className="border border-white/10 rounded-3xl p-8 bg-[#14120B] space-y-4 hover:border-white/25 transition-all">
        ...
        <div className="border border-white/10 rounded-3xl p-10 sm:p-16 bg-[#14120B] text-center space-y-6 shadow-2xl">
      ...
      <section id="pricing" className="py-24 px-6 sm:px-12 max-w-5xl mx-auto border-t border-white/[0.08] bg-[#14120B] text-center">
      ...
      <footer className="py-24 px-6 sm:px-12 border-t border-white/[0.08] bg-[#14120B] text-neutral-400 text-[13px]">
