...
export default function LandingPage({ onSignUp, onSignIn, onNavigatePricing, onNavigateLegal }) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#171615] text-white font-sans selection:bg-white selection:text-black">
      
      {/* ─── Top Header (No margin line under nav, right side is just Sign in and Get Started) ─── */}
      <header className="sticky top-0 z-50 w-full bg-[#171615] px-6 py-4 select-none">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            <div className="w-7 h-7 rounded-lg bg-[#171615] border border-white/15 flex items-center justify-center group-hover:border-white/30 transition-colors">
            ...
            >
              ...
              {resourcesOpen && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 w-[340px] pt-1 z-50">
                  <div className="bg-[#171615] border border-white/10 rounded-2xl p-2.5 shadow-2xl text-left">
      ...
      <section className="relative pt-20 sm:pt-28 pb-14 px-6 sm:px-12 max-w-7xl mx-auto bg-[#171615]">
        ...
        {/* ─── Apple-Style Clean Studio Window (Simple, Elegant, #171615) ─── */}
        <div className="w-full rounded-3xl border border-white/10 bg-[#171615] shadow-2xl overflow-hidden text-left">
          
          {/* Minimal Window Header Bar */}
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-white/[0.08] select-none bg-[#171615]">
            ...
            <div className="flex items-center gap-1.5 bg-[#171615] border border-white/10 rounded-lg p-1">
              <button
          ...
          {/* Window Body */}
          <div className="p-6 sm:p-8 bg-[#171615] grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            
            {/* Left: Prompt & Real-time AI Agent Reasoning */}
            <div className="lg:col-span-5 space-y-4">
              <div className="border border-white/10 rounded-2xl p-4 bg-[#171615]">
              ...
              <div className="border border-white/10 rounded-2xl p-4 bg-[#171615] space-y-3">
            ...
            <div className="lg:col-span-7 border border-white/10 rounded-2xl p-5 bg-[#171615] min-h-[340px] flex flex-col justify-between">
              {previewTab === 'code' ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="border border-white/10 rounded-xl p-4 bg-[#171615]">
                  ...
                  <div className="border border-white/10 rounded-xl p-4 bg-[#171615] text-[12px] text-neutral-300">
      ...
      <section id="about-us" className="py-28 px-6 sm:px-12 max-w-7xl mx-auto border-t border-white/[0.08] bg-[#171615] text-left">
        ...
        <div className="w-full rounded-3xl border border-white/10 bg-[#171615] overflow-hidden p-3 sm:p-4 mb-20 shadow-2xl">
          <div className="relative w-full rounded-2xl overflow-hidden bg-[#17150f] border border-white/5 aspect-[16/8] flex items-center justify-center group cursor-pointer">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#171615] via-transparent to-transparent pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          <div className="border border-white/10 rounded-3xl p-8 bg-[#171615] space-y-4 hover:border-white/25 transition-all">
        ...
        <div className="border border-white/10 rounded-3xl p-10 sm:p-16 bg-[#171615] text-center space-y-6 shadow-2xl">
      ...
      <section id="pricing" className="py-24 px-6 sm:px-12 max-w-5xl mx-auto border-t border-white/[0.08] bg-[#171615] text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch max-w-4xl mx-auto mb-10 text-left">
          ...
          {/* Card 1: $14 Pro */}
          <div className="flex flex-col bg-[#171615] rounded-3xl border border-white/20 p-8 hover:border-white/30 transition-all relative">
          ...
          {/* Card 2: $40 Max */}
          <div className="flex flex-col bg-[#171615] rounded-3xl border border-white/15 p-8 hover:border-white/25 transition-all text-left">
      ...
      <footer className="py-24 px-6 sm:px-12 border-t border-white/[0.08] bg-[#171615] text-neutral-400 text-[13px]">
