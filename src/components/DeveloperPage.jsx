...
export default function DeveloperPage() {
  ...
  return (
    <div className="flex-1 h-full overflow-y-auto bg-[#171615] text-white p-6 sm:p-10 select-none">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
          ...
          <div className="flex items-center gap-2 bg-[#1E1D1B] border border-white/[0.08] rounded-xl p-1 text-xs">
            <button
              type="button"
        ...
        {activeTab === 'keys' && (
          <div className="space-y-6">
            {/* Create Key Box */}
            <div className="p-5 rounded-2xl bg-[#1E1D1B] border border-white/[0.08] space-y-3">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 pt-1">
                <input
                  ...
                  className="flex-1 bg-[#11100F] border border-white/[0.08] rounded-xl px-3.5 py-2 text-xs text-white placeholder-neutral-500 outline-none focus:border-neutral-500 transition-colors"
                />
                <button
                  type="button"
            ...
            {/* Keys List */}
            <div className="rounded-2xl bg-[#1E1D1B] border border-white/[0.08] overflow-hidden">
...
print(response.choices[0].message.content)`}
        ...
        {activeTab === 'connectors' && (
          <div className="p-12 rounded-2xl bg-[#1E1D1B] border border-white/[0.08] text-center space-y-3">
