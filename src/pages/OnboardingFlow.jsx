...
export const OnboardingFlow = ({ onComplete, userProfile }) => {
  ...
  const stepVisuals = {
    1: {
      // Pink modern sculptural furniture / workspace
    ...
    2: {
      // Modern creator in high-tech architectural room
    ...
    3: {
      // Thoughtful artistic portrait with soft lighting
  ...
  return (
    <div className="min-h-screen w-full bg-[#1c1c1c] text-white flex flex-col font-sans select-none antialiased overflow-x-hidden">
      ...
      {/* ================================================================= */}
      {/* STEPS 1 TO 4: FULL-SCREEN 2-COLUMN QUESTIONNAIRE */}
      {/* ================================================================= */}
      {currentStep < 5 && (
        <div className="flex-1 w-full flex flex-col lg:flex-row min-h-screen">
          
          {/* Left Column: Full-Height Questionnaire Section (50% Width) */}
          <div className="w-full lg:w-1/2 min-h-screen flex flex-col justify-between p-6 sm:p-10 lg:p-16 bg-[#1c1c1c]">
            ...
            <div className="flex items-center gap-3 w-full max-w-lg mx-auto">
              <img 
                src="/calvras.png" 
                alt="Calvras Logo" 
                className="w-9 h-9 rounded-xl object-contain bg-white p-0.5 shadow-md"
                onError={(e) => {
            ...
            <div className="w-full max-w-lg mx-auto my-auto py-8 space-y-6">

              {/* STEP 1: USE CASE */}
              {currentStep === 1 && (
                <div className="space-y-6 animate-in fade-in duration-200">
                  <div className="space-y-1.5">
                    <h1 className="text-2xl sm:text-[32px] font-bold text-white tracking-tight leading-snug">
                    ...
                    {['School', 'Work', 'Personal', 'Other'].map((option) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-5 py-3 rounded-xl text-xs sm:text-sm font-medium transition cursor-pointer active:scale-95 ${
                            isSelected
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`px-4 sm:px-5 py-3 rounded-xl text-xs sm:text-sm font-medium transition cursor-pointer active:scale-95 ${
                            isSelected
                              ? 'bg-[#ff5e28] text-white font-semibold shadow-[0_2px_14px_rgba(255,94,40,0.35)] border border-[#ff5e28]'
                              : 'bg-[#282828] hover:bg-[#323232] text-neutral-200 border border-neutral-700/60'
                          }`}
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`px-4 py-2.5 rounded-xl text-xs sm:text-[13px] font-medium transition cursor-pointer active:scale-95 ${
                            isSelected
                              ? 'bg-[#ff5e28] text-white font-semibold shadow-[0_2px_14px_rgba(255,94,40,0.35)] border border-[#ff5e28]'
                              : 'bg-[#282828] hover:bg-[#323232] text-neutral-200 border border-neutral-700/60'
                          }`}
            ...
            <div className="pt-6 flex items-center justify-between border-t border-neutral-800 w-full max-w-lg mx-auto">
              {/* 5 Dots Indicator */}
              ...
              <div className="flex items-center gap-3">
                {currentStep > 1 && (
                  <button
                    type="button"
                    onClick={handleBack}
                    className="px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-neutral-400 hover:text-white bg-[#282828] hover:bg-[#333333] border border-neutral-700/60 transition cursor-pointer"
                  >
                    Back
                  </button>
                )}
          ...
          {/* Right Column: Full-Height Edge-to-Edge Hero Visual (50% Width) */}
          <div className="w-full lg:w-1/2 min-h-[440px] lg:min-h-screen p-4 sm:p-6 lg:p-8 flex items-center justify-center bg-[#1c1c1c]">
            <div className="w-full h-full min-h-[500px] lg:min-h-[calc(100vh-64px)] rounded-3xl overflow-hidden relative shadow-2xl border border-neutral-800 bg-[#101010] flex items-center justify-center">
              
              {currentStep === 4 ? (
                // Step 4: Social Discovery Grid Visual (Clean Vector-Style Icons)
                <div className="w-full h-full bg-[#f4f2ec] p-8 sm:p-12 grid grid-cols-3 gap-6 items-center justify-items-center">
                  {/* Instagram */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3.5 border border-neutral-200 transform hover:scale-105 transition">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm">
                      IG
                    </div>
                  </div>
                  {/* Newsletters / Editorial */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3 border border-neutral-200 transform hover:scale-105 transition">
                    <div className="w-full h-full rounded-xl bg-neutral-100 p-2 space-y-1.5 flex flex-col justify-center">
                      <div className="h-2 w-3/4 bg-neutral-400 rounded" />
                      <div className="h-1.5 w-full bg-neutral-300 rounded" />
                      <div className="h-1.5 w-1/2 bg-neutral-300 rounded" />
                    </div>
                  </div>
                  {/* Pinterest */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3 border border-neutral-200 transform hover:scale-105 transition">
                  ...
                  {/* TikTok */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3 border border-neutral-200 transform hover:scale-105 transition">
                    <span className="text-neutral-950 font-black text-3xl tracking-tighter">
                      d
                    </span>
                  </div>
                  {/* AI Chatbots */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3 border border-neutral-200 transform hover:scale-105 transition">
                    <div className="flex items-center gap-1.5">
                      <div className="w-3.5 h-3.5 rounded-full bg-neutral-900" />
                      <div className="w-3.5 h-3.5 rounded-full bg-neutral-900" />
                    </div>
                  </div>
                  {/* LinkedIn */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3 border border-neutral-200 transform hover:scale-105 transition">
                    <div className="w-12 h-12 rounded-xl bg-[#0077b5] flex items-center justify-center text-white font-bold text-sm">
                      in
                    </div>
                  </div>
                  {/* Community Chat */}
                  ...
                  {/* YouTube */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3 border border-neutral-200 transform hover:scale-105 transition">
                    <div className="w-12 h-9 rounded-xl bg-red-600 flex items-center justify-center text-white text-sm">
                      ▶
                    </div>
                  </div>
                  {/* X (Twitter) */}
                  <div className="w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center p-3 border border-neutral-200 transform hover:scale-105 transition">
                    <span className="font-bold text-neutral-900 text-2xl">𝕏</span>
                  </div>
                </div>
              ) : (
                ...
                <>
                  ...
                  <div className="absolute bottom-6 left-6 px-4 py-2 rounded-xl bg-black/60 backdrop-blur-md border border-white/15 text-xs font-medium text-white/90">
      ...
      {/* ================================================================= */}
      {currentStep === 5 && (
        <div className="min-h-screen w-full bg-[#1c1c1c] p-6 sm:p-10 lg:p-16 flex flex-col justify-between space-y-8 animate-in fade-in zoom-in-95 duration-200">
          ...
          {/* 3 Plan Cards Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto w-full pt-4">
            
            {/* 1. FREE PLAN */}
            <div className="bg-[#242424] hover:bg-[#282828] rounded-3xl border border-neutral-800 p-6 sm:p-8 flex flex-col justify-between space-y-6 transition hover:border-neutral-700">
              <div className="space-y-4">
                ...
                <div className="pt-2 text-xs text-neutral-300 space-y-3">
            ...
            <div className="bg-[#242424] rounded-3xl border-2 border-[#8057ff] p-6 sm:p-8 flex flex-col justify-between space-y-6 relative shadow-[0_0_30px_rgba(128,87,255,0.15)]">
              
              {/* Recommended Badge */}
              <div className="absolute -top-3 right-8 bg-[#8057ff] text-white text-[10px] font-bold uppercase tracking-wider px-3.5 py-1 rounded-full shadow-md">
                Recommended
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-1 text-xs text-neutral-300 space-y-3">
          ...
          <div className="pt-4 flex items-center justify-between border-t border-neutral-800 max-w-6xl mx-auto w-full">
            <button
              type="button"
              onClick={() => setCurrentStep(4)}
              className="text-xs font-semibold text-neutral-400 hover:text-white px-4 py-2.5 rounded-xl bg-[#282828] hover:bg-[#333333] border border-neutral-700/60 transition cursor-pointer"
            >
