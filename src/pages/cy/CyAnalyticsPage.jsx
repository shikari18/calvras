...
export const CyAnalyticsPage = ({ userName = 'SHIKARI', onNewChat }) => {
  ...
  return (
    <div className="flex-1 min-h-screen bg-[#1c1c1c] flex flex-col justify-start p-4 sm:p-8 lg:p-10 font-sans antialiased text-white select-none overflow-y-auto w-full min-w-0 text-left">
      ...
      <div className="max-w-6xl mx-auto w-full space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-5">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-white/10 bg-[#242424] shadow-2xs text-xs font-medium text-neutral-300">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-white hover:bg-neutral-100 text-neutral-950 text-xs font-semibold shadow-xs transition cursor-pointer"
            >
              <Download size={13} />
        ...
        <div className="bg-[#242424] border border-white/10 rounded-2xl p-5 shadow-xs space-y-4">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-[#1c1c1c] border border-white/10 rounded-xl px-4 py-2.5 pl-10 text-xs sm:text-[13px] text-white placeholder:text-neutral-500 focus:outline-none focus:border-white/30 transition"
            />
            <Search size={15} className="absolute left-3.5 text-neutral-400" />
            <button
              onClick={() => handleAskData()}
              disabled={isAnalyzing}
              className="absolute right-2 px-3 py-1.5 rounded-lg bg-white hover:bg-neutral-100 text-neutral-950 text-xs font-semibold flex items-center gap-1 transition cursor-pointer"
            >
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            {sampleQueries.map((query, i) => (
              <button
                ...
                className="text-[11px] font-medium text-neutral-600 bg-neutral-100/80 hover:bg-neutral-200/70 border border-neutral-200/60 px-2.5 py-1 rounded-lg transition cursor-pointer"
              >
                {query}
              </button>
            ))}
          ...
          {analysisResult && (
            <div className="mt-4 p-4 rounded-xl bg-purple-950/30 border border-purple-800/40 space-y-3 animate-in fade-in duration-200">
              <div className="flex items-center justify-between border-b border-purple-800/40 pb-2">
                ...
                <span className="text-[10.5px] font-semibold text-purple-300 bg-purple-900/50 px-2 py-0.5 rounded-md font-mono">
              ...
              <div className="space-y-1.5 pt-2 border-t border-purple-800/40">
                <span className="text-[11px] font-bold text-emerald-400 uppercase tracking-wider block">Prioritized AI Action Steps:</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-[#242424] border border-white/10 rounded-2xl p-4 shadow-2xs space-y-2">
          ...
          <div className="bg-[#242424] border border-white/10 rounded-2xl p-4 shadow-2xs space-y-2">
            <div className="flex items-center justify-between text-neutral-400 text-xs">
              ...
              <Target size={15} className="text-neutral-500" />
            </div>
        ...
        <div className="bg-[#242424] border border-white/10 rounded-2xl p-5 shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-bold text-neutral-300 bg-[#1c1c1c] px-2.5 py-1 rounded-lg border border-white/10">
              ...
              <tbody className="divide-y divide-white/10">
                {channelPerformance.map((ch, idx) => (
                  <tr key={idx} className="hover:bg-white/5 transition">
                    ...
                    <td className="py-3 px-3 font-mono text-neutral-300">{ch.spend}</td>
                    <td className="py-3 px-3 font-mono font-bold text-white">{ch.revenue}</td>
                    <td className="py-3 px-3 font-mono font-bold text-purple-400">{ch.roas}</td>
        ...
        <div className="bg-[#242424] border border-white/10 rounded-2xl p-5 shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
            <div className="p-3 bg-[#1c1c1c] rounded-xl border border-white/10 text-center">
