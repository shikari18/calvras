        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-200/80 pb-5">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-neutral-950 hover:bg-neutral-800 text-white text-xs font-semibold shadow-xs transition cursor-pointer"
            >
              <Download size={13} />
        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-5 shadow-xs space-y-4">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-neutral-50 border border-neutral-200 rounded-xl px-4 py-2.5 pl-10 text-xs sm:text-[13px] text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-purple-600 focus:bg-white transition"
            />
          ...
          {analysisResult && (
            <div className="mt-4 p-4 rounded-xl bg-purple-50/50 border border-purple-100/80 space-y-3 animate-in fade-in duration-200">
              <div className="flex items-center justify-between border-b border-purple-100 pb-2">
                <div className="flex items-center gap-2">
                  <BrandBurstLogo size={16} />
                  <span className="text-xs font-bold text-neutral-950">{analysisResult.title}</span>
                </div>
                <span className="text-[10.5px] font-semibold text-purple-700 bg-purple-100/70 px-2 py-0.5 rounded-md font-mono">
        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-5 shadow-xs space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-neutral-100 text-neutral-400 font-medium uppercase text-[10.5px]">
              ...
              <tbody className="divide-y divide-neutral-100">
                {channelPerformance.map((ch, idx) => (
                  <tr key={idx} className="hover:bg-neutral-50/80 transition">
                    ...
                    <td className="py-3 px-3 font-mono text-neutral-700">{ch.spend}</td>
        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-5 shadow-xs space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <div className="text-right">
              ...
              <span className="text-sm font-bold text-neutral-900 font-mono">${budgetSlider.toLocaleString()}</span>
            </div>
          </div>
